...
import { Star, MapPin, Clock, Filter, Search, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function ProvidersPage() {
  ...
  const filteredProviders = providers.filter(provider => {
    ...
    const matchesPriceRange = (!priceRange.min || provider.hourlyRate >= Number(priceRange.min)) &&
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="text-right">
                          <p className="font-semibold">MT{provider.hourlyRate}/hora</p>
