			...
			<div className='max-w-md w-full text-center'>
				...
				>
					...
					<p className='text-gray-600 dark:text-gray-400 mb-8'>
						Desculpe, a página que você está procurando ainda não foi construída
						ou está em reforma.
					</p>
					...
					<Link href='/'>
						<Button
							size='lg'
							className='bg-text-primary hover:bg-text-primary/80 text-white inline-flex items-center gap-2'
						>
