	...
	const categories = [
		{
			...
			icon: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&q=80&w=200&h=200',
		},
		{
			name: 'Beleza & Bem-estar',
			icon: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?auto=format&fit=crop&q=80&w=200&h=200',
		},
		{
			name: 'Negócios & Tecnologia',
			icon: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=200&h=200',
		},
		{
			name: 'Criação & Design',
			icon: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?auto=format&fit=crop&q=80&w=200&h=200',
		},
	];
			...
			<section className='relative h-[600px] flex items-center justify-center text-white'>
				...
				<div className='container relative z-10 text-center'>
					...
					<p className='text-xl mb-8 max-w-2xl mx-auto'>
						Conecte-se com profissionais qualificados para todas as suas
						necessidades. Serviço de qualidade, satisfação garantida.
					</p>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
						<div className='text-center'>
							...
							<p className='text-gray-600'>
								Todos os prestadores de serviços são cuidadosamente verificados
							</p>
						</div>
						<div className='text-center'>
							<div className='w-12 h-12 mx-auto mb-4 rounded-full bg-[#f18701]/10 flex items-center justify-center'>
							...
							<p className='text-gray-600'>
								Serviços consistentemente bem avaliados por profissionais
								qualificados
							</p>
						</div>
						<div className='text-center'>
							...
							<p className='text-gray-600'>
								Agendamento fácil e confirmação instantânea
							</p>
						</div>
						<div className='text-center'>
							<div className='w-12 h-12 mx-auto mb-4 rounded-full bg-[#f18701]/10 flex items-center justify-center'>
							...
							<p className='text-gray-600'>
								Transações protegidas com serviço de garantia
							</p>
						</div>
					</div>
				</div>
